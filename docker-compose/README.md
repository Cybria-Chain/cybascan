...
Runs Cybascan locally in Docker containers with [docker-compose](https://github.com/docker/compose).
...
- Cybascan backend with api at /api path.
- Nginx proxy to bind backend, frontend and microservices.
- Cybascan explorer at http://localhost.
...
You can adjust Cybascan environment variables:
