defmodule BlockScoutWeb.ApiDocsViewTest do
  ...
  describe "api_url/1" do
    ...
    test "adds slash before path" do
      Application.put_env(:block_scout_web, BlockScoutWeb.Endpoint,
        url: [scheme: "https", host: "explorer.cybascan.io", port: 9999, path: "/chain/dog"]
      )

      assert APIDocsView.api_url() == "https://explorer.cybascan.io/chain/dog/api"
    end

    test "does not add slash to empty path" do
      Application.put_env(:block_scout_web, BlockScoutWeb.Endpoint,
        url: [scheme: "https", host: "explorer.cybascan.io", port: 9999, path: ""]
      )

      assert APIDocsView.api_url() == "https://explorer.cybascan.io/api"
    end
  ...
  describe "blockscout_url/1" do
    ...
    test "set_path = true returns url with path" do
      Application.put_env(:block_scout_web, BlockScoutWeb.Endpoint,
        url: [scheme: "https", host: "explorer.cybascan.io", path: "/eth/mainnet"]
      )

      assert APIDocsView.blockscout_url(true) == "https://explorer.cybascan.io/eth/mainnet"
    end
    ...
    test "set_path = false returns url w/out path" do
      ...
      assert APIDocsView.blockscout_url(false) == "https://explorer.cybascan.io"
    end
  end
  ...
  describe "eth_rpc_api_url/1" do
    ...
    test "adds slash before path" do
      ...
      assert APIDocsView.eth_rpc_api_url() == "https://explorer.cybascan.io/chain/dog/api/eth-rpc"
    end
    ...
    test "does not add slash to empty path" do
      ...
      assert APIDocsView.eth_rpc_api_url() == "https://explorer.cybascan.io/api/eth-rpc"
    end
