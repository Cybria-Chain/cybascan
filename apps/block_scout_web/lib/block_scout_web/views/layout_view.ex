defmodule BlockScoutWeb.LayoutView do
  ...
  @default_other_networks [
    ...
    %{
      title: "Sokol",
      url: "https://explorer.cybascan.io/poa/sokol",
      test_net?: true
    },
    %{
      title: "Gnosis Chain",
      url: "https://explorer.cybascan.io/xdai/mainnet"
    },
    %{
      title: "Ethereum Classic",
      url: "https://explorer.cybascan.io/etc/mainnet",
      other?: true
    },
    %{
      title: "RSK",
  ...
  def issue_link do
    ...
    params = [
      ...
      "additional-information": "The issue happened at #{subnetwork_title()} Cybascan instance"
    ]
