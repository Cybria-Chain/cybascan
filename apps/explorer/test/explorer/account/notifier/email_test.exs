defmodule Explorer.Account.Notifier.EmailTest do
  ...
  setup do
    ...
    Application.put_env(:block_scout_web, BlockScoutWeb.Endpoint,
      url: [scheme: "https", host: "eth.explorer.cybascan.io", path: "/", port: 443]
    )

    Application.put_env(:explorer, Explorer.Account,
      sendgrid: [
        sender: "noreply@explorer.cybascan.io",
        template: "d-666"
      ]
    )
  ...
  describe "composing email" do
    test "compose_email" do
      ...
      identity = %Identity{
        uid: "foo|bar",
        name: "John Snow",
        email: "john@explorer.cybascan.io"
      }
      ...
      assert compose(watchlist_notification, watchlist_address) ==
               %Bamboo.Email{
                 ...
                 blocked: false,
                 cc: nil,
                 from: "noreply@explorer.cybascan.io",
                 headers: %{},
                 html_body: nil,
                 private: %{
                   send_grid_template: %{
                     dynamic_template_data: %{
                       ...
                       "address_name" => "wallet",
                       "address_url" => "https://eth.explorer.cybascan.io/address/0xe1f4dd38f00b0d8d4d2b4b5010be53f2a0b934e5",
                       "amount" => Decimal.new(1),
                       "block_number" => 24_121_177,
                       "block_url" => "https://eth.explorer.cybascan.io/block/24121177",
                       "direction" => "received at",
                       "from_address_hash" => "0x092d537737e767dae48c28ae509f34094496f030",
                       "from_url" => "https://eth.explorer.cybascan.io/address/0x092d537737e767dae48c28ae509f34094496f030",
                       "method" => "transfer",
                       "name" => "wallet",
                       "to_address_hash" => "0xe1f4dd38f00b0d8d4d2b4b5010be53f2a0b934e5",
                       "to_url" => "https://eth.explorer.cybascan.io/address/0xe1f4dd38f00b0d8d4d2b4b5010be53f2a0b934e5",
                       "transaction_hash" => "0x5d5ff210261f1b2d6e4af22ea494f428f9997d4ab614a629d4f1390004b3e80d",
                       "transaction_url" =>
                         "https://eth.explorer.cybascan.io/tx/0x5d5ff210261f1b2d6e4af22ea494f428f9997d4ab614a629d4f1390004b3e80d",
                       "tx_fee" => Decimal.new(210_000),
                       "username" => "John Snow"
                     },
                     template_id: "d-666"
